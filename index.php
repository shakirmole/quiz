<?php
	...
	if ( !empty($member) ) {
		...
		define('SCHOOLID',$_SESSION['member']['schoolid']);
	}
	else {
		define('USER_ID','');
		define('COLOR','green');
	...
	define('VALIDATEFORM','data-role="validator" data-show-required-state="true" data-on-error-input="notifyOnErrorInput" data-show-error-hint="true" data-hint-background="bg-red" data-hint-color="fg-white" data-hide-error="5000"');
